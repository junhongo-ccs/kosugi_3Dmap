...
- 国土数値情報 洪水浸水想定区域データ（河川単位）を加工した浸水想定区域を半透明ポリゴンで表示
- 想定最大規模の浸水深ランクに応じて、ポリゴンの色と3D上の高さを変えて表示
...
| 国土数値情報 | 洪水浸水想定区域データ（河川単位）、鉄道駅、公共施設、避難施設候補 | 多摩川 / 想定最大規模 / 2025年データをQGISで切り出し、`public/data/flood_risk.geojson` として表示 |
...
- 洪水浸水想定区域はQGISで多摩川 / 想定最大規模に絞り、武蔵小杉・新丸子・等々力方面を含む範囲に切り出す
- QGISは目視確認、属性確認、境界の妥当性チェックに使う
- 表示用GeoJSONには、地図表示、凡例、詳細パネルに必要な属性だけ残す
...
- 浸水想定レイヤーは仮の矩形ではなく、国土数値情報 洪水浸水想定区域データ（河川単位）の多摩川 / 想定最大規模を元に表示される
- 浸水深ランクに応じて、色だけでなく3D上の高さでも最大浸水想定を確認できる
